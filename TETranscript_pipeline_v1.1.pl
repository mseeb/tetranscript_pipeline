...
#
my @opts = qw( genome|g=s dir=s trim hisat2 star debug=s samples|s=s countsOnly bigwigs);
...
my $hisat2_index; my $gene_gtf; my $rep_gtf; my $genome_size; my $star_index;
...
## create bigwigs
##################################################################
if ( defined $options{'bigwigs'}) {
  print "\t\t---------------------------------\n\t\tBIGWIGS\n\n";
  my $bw_dir = $outdir."/03_bigwigs";
